...
typedef vector<Expr*>::size_type vec_sz;			/// the size of a vector
void mandatory2_test()
{
  ...
  for (vector<Expr*>::const_iterator it = expressions.begin();
...
int main()
{
  ...
  Num num3 (3);
  Num num4 (4);
  Plus num3_4(&num3, &num4);
  Mult expr_num(&num2, &num3_4);
